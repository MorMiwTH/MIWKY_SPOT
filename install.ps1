...
***************** 
@mrpond message:
#Discord: MIW#0009 #MIW_ON_TOP
THIS PROGRAM MADE BY MIW#0009
***************** 
'@

write-host @'
***************** 
Author: @MIW#0009_DISCORD
***************** 
'@
...
if (Get-AppxPackage -Name SpotifyAB.SpotifyMusic) {
  Write-Host @'
DETECTED SPOTIFY FROM MICROSOFT STORE NOT SUPPORT!!!!
'@`n
  $ch = Read-Host -Prompt "UNINSTALL SPOTIFY FROM MICROSOFT STORE (Y/N) "
  if ($ch -eq 'y'){
     Write-Host @'
